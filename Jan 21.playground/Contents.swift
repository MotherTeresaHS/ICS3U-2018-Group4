...
class MainMenuScene: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        highScoreLabel.fontColor = #colorLiteral(red: 0.9254902005195618, green: 0.23529411852359772, blue: 0.10196078568696976, alpha: 1.0)
        highScoreLabel.fontSize = 50
        highScoreLabel.position = CGPoint(x: frame.size.width / 1.8, y: frame.size.height / 1.1)
